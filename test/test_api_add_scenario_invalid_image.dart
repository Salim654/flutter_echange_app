...
void main() {
  testWidgets('Test scenario  invalid no  image for adding product', (WidgetTester tester) async {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(builder: (context) =>  AddProductScreen(categoriessends: exampleCategories)),
    );
    ...
    expect(find.text('Select at least one image'), findsOneWidget);
